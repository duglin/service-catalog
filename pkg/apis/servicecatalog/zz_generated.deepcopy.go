...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_servicecatalog_AlphaUserInfo, InType: reflect.TypeOf(&AlphaUserInfo{})},
...
// DeepCopy_servicecatalog_AlphaUserInfo is an autogenerated deepcopy function.
func DeepCopy_servicecatalog_AlphaUserInfo(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*AlphaUserInfo)
		out := out.(*AlphaUserInfo)
		*out = *in
		if in.Groups != nil {
		...
		if in.Extra != nil {
			...
			*out = make(map[string]AlphaExtraValue)
			for key, val := range *in {
				if newVal, err := c.DeepCopy(&val); err != nil {
					return err
				} else {
					(*out)[key] = *newVal.(*AlphaExtraValue)
				}
			}
		}
		return nil
		...
		if in.AlphaActionUser != nil {
			...
			*out = make(map[string]AlphaUserInfo)
			for key, val := range *in {
				...
				if err := DeepCopy_servicecatalog_AlphaUserInfo(&val, newVal, c); err != nil {
					return err
				}
				(*out)[key] = *newVal
			}
