...
func (x *AlphaUserInfo) CodecEncodeSelf(e *codec1978.Encoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	if x == nil {
				...
				if yyq2[3] {
					if x.Extra == nil {
						...
						if false {
							...
							h.encMapstringAlphaExtraValue((map[string]AlphaExtraValue)(x.Extra), e)
						}
					}
				} else {
					r.EncodeNil()
...
func (x *AlphaUserInfo) CodecDecodeSelf(d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	yym1 := z.DecBinary()
...
func (x *AlphaUserInfo) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	var yys3Slc = z.DecScratchBuffer() // default slice to decode into
		...
		case "extra":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decMapstringAlphaExtraValue((*map[string]AlphaExtraValue)(yyv10), d)
				}
			}
		default:
			z.DecStructFieldNotFound(-1, yys3)
...
func (x *AlphaUserInfo) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	var yyj12 int
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decMapstringAlphaExtraValue((*map[string]AlphaExtraValue)(yyv19), d)
		}
	}
	for {
		yyj12++
...
func (x AlphaExtraValue) CodecEncodeSelf(e *codec1978.Encoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	if x == nil {
		...
		if false {
			...
			h.encAlphaExtraValue((AlphaExtraValue)(x), e)
		}
	}
}

func (x *AlphaExtraValue) CodecDecodeSelf(d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	yym1 := z.DecBinary()
	...
	if false {
		...
		h.decAlphaExtraValue((*AlphaExtraValue)(x), d)
	}
}
...
func (x *InstanceStatus) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			yyq2[5] = len(x.AlphaActionUser) != 0
			var yynn2 int
			if yyr2 || yy2arr2 {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[5] {
					if x.AlphaActionUser == nil {
						...
						if false {
							...
							h.encMapstringAlphaUserInfo((map[string]AlphaUserInfo)(x.AlphaActionUser), e)
						}
					}
				} else {
					r.EncodeNil()
				...
				if yyq2[5] {
					z.EncSendContainerState(codecSelfer_containerMapKey1234)
					r.EncodeString(codecSelferC_UTF81234, string("alphaActionUser"))
					z.EncSendContainerState(codecSelfer_containerMapValue1234)
					if x.AlphaActionUser == nil {
						r.EncodeNil()
					} else {
...
func (x *InstanceStatus) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "alphaActionUser":
			if r.TryDecodeAsNil() {
				x.AlphaActionUser = nil
			} else {
				yyv14 := &x.AlphaActionUser
				yym15 := z.DecBinary()
				_ = yym15
				if false {
				} else {
					h.decMapstringAlphaUserInfo((*map[string]AlphaUserInfo)(yyv14), d)
				}
			}
		default:
			z.DecStructFieldNotFound(-1, yys3)
...
func (x *InstanceStatus) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		yyv27 := &x.AlphaActionUser
		yym28 := z.DecBinary()
		_ = yym28
		if false {
		} else {
			h.decMapstringAlphaUserInfo((*map[string]AlphaUserInfo)(yyv27), d)
		}
	}
	for {
		yyj16++
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "AlphaActionUser":
			if r.TryDecodeAsNil() {
				...
				yyv8 := &x.AlphaActionUser
				yym9 := z.DecBinary()
				_ = yym9
				if false {
				} else {
					h.decMapstringAlphaUserInfo((*map[string]AlphaUserInfo)(yyv8), d)
				}
			}
		default:
			z.DecStructFieldNotFound(-1, yys3)
...
func (x *BindingStatus) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSliceBindingCondition((*[]BindingCondition)(yyv11), d)
		}
	}
	yyj10++
	if yyhl10 {
	...
	if r.TryDecodeAsNil() {
		...
		yyv15 := &x.AlphaActionUser
		yym16 := z.DecBinary()
		_ = yym16
		if false {
		} else {
			h.decMapstringAlphaUserInfo((*map[string]AlphaUserInfo)(yyv15), d)
		}
	}
	for {
		yyj10++
...
func (x codecSelfer1234) encMapstringAlphaExtraValue(v map[string]AlphaExtraValue, e *codec1978.Encoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
...
func (x codecSelfer1234) decMapstringAlphaExtraValue(v *map[string]AlphaExtraValue, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	...
	if yyv1 == nil {
		...
		yyv1 = make(map[string]AlphaExtraValue, yyrl1)
		*v = yyv1
	}
	var yymk1 string
	var yymv1 AlphaExtraValue
	var yymg1 bool
...
func (x codecSelfer1234) encAlphaExtraValue(v AlphaExtraValue, e *codec1978.Encoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer1234) decAlphaExtraValue(v *AlphaExtraValue, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer1234) encMapstringAlphaUserInfo(v map[string]AlphaUserInfo, e *codec1978.Encoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeMapStart(len(v))
...
func (x codecSelfer1234) decMapstringAlphaUserInfo(v *map[string]AlphaUserInfo, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	...
	if yyv1 == nil {
		...
		yyv1 = make(map[string]AlphaUserInfo, yyrl1)
		*v = yyv1
	}
	var yymk1 string
	var yymv1 AlphaUserInfo
	var yymg1 bool
	if yybh1.MapValueReset {
		yymg1 = true
	}
