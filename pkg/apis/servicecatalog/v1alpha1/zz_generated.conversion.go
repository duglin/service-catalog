...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		Convert_v1alpha1_AlphaUserInfo_To_servicecatalog_AlphaUserInfo,
		Convert_servicecatalog_AlphaUserInfo_To_v1alpha1_AlphaUserInfo,
...
func autoConvert_v1alpha1_AlphaUserInfo_To_servicecatalog_AlphaUserInfo(in *AlphaUserInfo, out *servicecatalog.AlphaUserInfo, s conversion.Scope) error {
	out.Username = in.Username
	out.UID = in.UID
	out.Groups = *(*[]string)(unsafe.Pointer(&in.Groups))
	out.Extra = *(*map[string]servicecatalog.AlphaExtraValue)(unsafe.Pointer(&in.Extra))
	return nil
}

// Convert_v1alpha1_AlphaUserInfo_To_servicecatalog_AlphaUserInfo is an autogenerated conversion function.
func Convert_v1alpha1_AlphaUserInfo_To_servicecatalog_AlphaUserInfo(in *AlphaUserInfo, out *servicecatalog.AlphaUserInfo, s conversion.Scope) error {
	return autoConvert_v1alpha1_AlphaUserInfo_To_servicecatalog_AlphaUserInfo(in, out, s)
}

func autoConvert_servicecatalog_AlphaUserInfo_To_v1alpha1_AlphaUserInfo(in *servicecatalog.AlphaUserInfo, out *AlphaUserInfo, s conversion.Scope) error {
	out.Username = in.Username
	out.UID = in.UID
	out.Groups = *(*[]string)(unsafe.Pointer(&in.Groups))
	out.Extra = *(*map[string]AlphaExtraValue)(unsafe.Pointer(&in.Extra))
	return nil
}

// Convert_servicecatalog_AlphaUserInfo_To_v1alpha1_AlphaUserInfo is an autogenerated conversion function.
func Convert_servicecatalog_AlphaUserInfo_To_v1alpha1_AlphaUserInfo(in *servicecatalog.AlphaUserInfo, out *AlphaUserInfo, s conversion.Scope) error {
	return autoConvert_servicecatalog_AlphaUserInfo_To_v1alpha1_AlphaUserInfo(in, out, s)
}
